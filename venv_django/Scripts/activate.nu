...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\OWNER\Desktop\Application\django-demo\venv_django'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\OWNER\Desktop\Application\django-demo\venv_django\Scripts\deactivate.nu'
